"""Published RMF parameter sets used by the solver modules."""
...
# Parameters for SFHo EOS from compose, values in Steiner, Fischer et.al. are wrong!
#https://compose.obspm.fr/eos/34 
MeV_fm_SFHoW = 197.3269631
paraSFHoWRONG=[[939.565346,938.272013],[2.3714*MeV_fm_SFHoW,762.5,770],[-.5,.5],[2.3714*3.1780,2.3714*3.1780],[762.5/MeV_fm_SFHoW*2.2726,762.5/MeV_fm_SFHoW*2.2726],[770/MeV_fm_SFHoW*2.4047,770/MeV_fm_SFHoW*2.4047],[7.4653*10**(-3),-4.0887*10**(-3),939],[-1.7013*10**(-3)],[3.4525*10**(-3)],[5.8729,-1.6442*MeV_fm_SFHoW**(-2),3.1464*10**2*MeV_fm_SFHoW**(-4),-2.3016*10**(-1)*MeV_fm_SFHoW,5.7972*10**(-1),3.4446*10**(-1)*MeV_fm_SFHoW**(-1),3.4593*MeV_fm_SFHoW**(-2),1.3473*MeV_fm_SFHoW**(-3),6.6061*10**(-1)*MeV_fm_SFHoW**(-4)],0.1583*MeV_fm_SFHoW**3,-1,0];
